...
class CreateApplicationExpectedArrivalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('application_expected_arrivals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('application_expected_arrivals');
    }
}

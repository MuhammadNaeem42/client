...
class CreateApplicationDeportationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('application_deportations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('application_deportations');
    }
}

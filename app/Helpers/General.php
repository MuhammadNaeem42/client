    ...
    function getAllPermissions()
    {
        ...
        foreach ($modules as $module => $value) {
            ...
            foreach (explode(',', $value) as $p => $perm) {
                ...
                // create permissions
                $permission = $permissionValue . '_' . $module;
                array_push($all_permission_created, $permission);
                $all_permission[$module][] = $permission;
            }

        }

        $data_permissions = [
            'all_permission' => $all_permission_created,
            'all_permission_format' => $all_permission,
        ];

        return $data_permissions;//$all_permission_created;
...
if (!function_exists('getAllMolesWithPermissions')) {
    function getAllMolesWithPermissions()
    {
        ...
        $models = [
            'applications' => 'l,s,c,u,d',
            'application_reservations' => 'l,s,c,u,d',
            'application_visas' => 'l,s,c,u,d',
            'application_expected_arrival' => 'l,s,c,u,d',
            'application_arrival' => 'l,s,c,u,d',
            'application_deportation' => 'l,s,c,u,d',
            'application_deliver' => 'l,s,c,u,d',
            'application_resell' => 'l,s,c,u,d',

            'sponsors' => 'l,s,c,u,d',
            'journals' => 'l,s,c,u,d',
            'internal_offices' => 'l,s,c,u,d',
            'external_offices' => 'l,s,c,u,d',
            'countries' => 'l,s,c,u,d',
            'educations' => 'l,s,c,u,d',
            'religions' => 'l,s,c,u,d',
            'jobs' => 'l,s,c,u,d',
            'external_office_transactions' => 'l,s,c,u,d',
            'account_items' => 'l,s,c,u,d',
            'currencies' => 'l,s,c,u,d',
...
if (!function_exists('getFirstCharFromWords')) {
    function getFirstCharFromWords($str)
    {

        $words = explode("-", Str::slug($str));
        $code = "";
        foreach ($words as $w) {
            $code .= $w[0];
        }
...
if (!function_exists('getAvailLocaleLanguage')) {

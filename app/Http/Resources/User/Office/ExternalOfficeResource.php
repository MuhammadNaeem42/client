...
class ExternalOfficeResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $history_payment_cards = [
            'income'=>rand(100,1000),
            'refund'=>rand(100,1000),
        ...
        return [
            ...
            'internal_offices' => InternalOfficeResource::collection($this->whenLoaded('internal_offices')),
            ...
            'history_payment_cards' => $history_payment_cards,//TODO implement history_payment_cards from accounting
